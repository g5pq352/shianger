...
<body>
	...
	<div class="loginWrap">
		...
		<div class="login-container">
			<div class="head"><img src="images/login-head.svg" width="300"></div>
			...
			<form action="member.php" method="POST" class="loginForm">
				...
				<button class="btn"><img src="images/btn-login.svg" width="160"></button>

				<div class="join"><a href="join.php"><img src="images/btn-join.svg" width="160"></a></div>
			</form>

			<form action="login.php" method="POST" class="forgotForm">
				<div class="field-container">
					<div class="item">
						<div class="title">忘記密碼</div>
						<div class="box">
							<div class="star"></div>
							<input type="text" name="" id="" placeholder="請輸入您的電子郵件">
						</div>
					</div>
				</div>
				<button class="forgot"><img src="images/btn-forgot.svg" width="160"></button>
			</form>
		</div>
	</div>
